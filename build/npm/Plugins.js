const Plugins = [
  ...
  // bootstrap-fileinput
  {
    from: 'node_modules/bootstrap-fileinput/css',
    to: 'plugins/bootstrap-fileinput/css'
  },
  {
    from: 'node_modules/bootstrap-fileinput/js',
    to: 'plugins/bootstrap-fileinput/js'
  },
  {
    from: 'node_modules/glyphicons-only-bootstrap/css',
    to: 'plugins/glyphicons-only-bootstrap/css'
  },
  {
    from: 'node_modules/glyphicons-only-bootstrap/fonts',
    to: 'plugins/glyphicons-only-bootstrap/fonts'
  },
  {
  ...
  {
    from: 'node_modules/promise-polyfill/dist',
    to: 'plugins/promise-polyfill/'
  },
